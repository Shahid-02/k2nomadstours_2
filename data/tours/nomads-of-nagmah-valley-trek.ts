...
export const nomadsOfNagmahValleyTrek: Tour = {
  ...
  itinerary: [
    { day: 1, title: "Islamabad International Airport", activities: ["Guide greets you and transfers to the hotel", "Leisure time to relax and recover from the journey", "Tour briefing after lunch", "Market trip for supplies and currency exchange", "Stops at Lok Virsa Museum and the Shah Faisal Mosque"], accommodation: "Hotel", image: { src: "/images/photos/Islamabad International Airport.webp", alt: "Islamabad city view", width: 1200, height: 800 } },
    { day: 2, title: "Fly to Skardu — If flight cancels, drive on the KKH to Chilas", activities: ["Thrilling scenic flight with breathtaking views of Nanga Parbat and other mountain peaks", "Transfer by local vehicle to Skardu and hotel check-in", "Weather backup: 10–12 hour drive from Islamabad to Chilas over the Karakoram Highway"], accommodation: "Hotel", image: { src: "/images/photos/chilas.jpg", alt: "Chilas city view", width: 1200, height: 800 } },
    { day: 3, title: "Skardu Sightseeing Day", activities: ["Visit Skardu's Kharpocho Fort, perched on a mountain with breathtaking views of the Indus River and town below", "Optional tour to Sadpara Lake", "Free time in Skardu Bazaar"], accommodation: "Hotel", image: { src: "/images/photos/skardu-sightseeing.jpeg", alt: "Khaplu Palace in Skardu, Gilgit Baltistan", width: 1200, height: 800 } },
    { day: 4, title: "Drive to Khaplu", activities: ["3-hour drive via picturesque Baltistan villages through the Ghanche district", "Brief stops at Thorgo Pari and the Shayok–Indus river confluence, plus a suspension-bridge walk at Keris", "Yugo village tour — fresh fruit picking, organic farming, and time with local artists and elders", "Visit a classic water flour mill and lunch of Balti cuisine made by local women", "Evening sunset walk at Hanjore Broq"], accommodation: "Hotel", image: { src: "/images/photos/Khaplu_Palace_Skardu,_Gilgit_Baltistan,_Pakistan.jpg", alt: "Khaplu Palace in Skardu, Gilgit Baltistan", width: 1200, height: 800 } },
    { day: 5, title: "Drive to Kanday & Trek to Mingulo Broq", activities: ["2-hour drive from Khaplu to Kanday hamlet", "Trek to Mingulo Broq at 3,500m through lush green meadows and stone-wall villages", "Afternoon leisure time for natural exploration"], accommodation: "Camping", image: { src: "/images/photos/nangmah-valley.jpg", alt: "The dramatic granite rock towers of Nangmah Valley", width: 1200, height: 800 } },
    { day: 6, title: "Trek to Amin Broq Base Camp", activities: ["Trek to Amin Broq Base Camp at 4,500m", "Early rise for sunrise, explore a nearby glacial stream", "Optional scrambling on nearby rocks", "Spot Karakoram bird and flower species"], accommodation: "Camping", image: { src: "/images/photos/ThalayLaTrek.jpg", alt: "High altitude trek through the Karakoram mountains", width: 1200, height: 800 } },
    ...
    { day: 10, title: "Drive from Skardu to Chilas", activities: ["Scenic road journey following the Indus River, past deep gorges and rugged cliffs", "Showcases the raw beauty of the Karakoram region"], accommodation: "Guesthouse", image: { src: "/images/photos/chilas.jpg", alt: "Chilas city view", width: 1200, height: 800 } },
    { day: 11, title: "Drive from Chilas to Islamabad", activities: ["Long but scenic journey along the Karakoram Highway (KKH), the 'Eighth Wonder of the World'", "Spectacular views of the Indus River, towering mountains, and rugged valleys"], accommodation: "Hotel", image: { src: "/images/photos/KKH.jpeg", alt: "Karakoram Highway view", width: 1200, height: 800 } },
    { day: 12, title: "Fly Back Home", activities: ["Transfer to the airport in time for the international flight"], image: { src: "/images/photos/flight.jpeg", alt: "Flight to Islamabad", width: 1200, height: 800 } },
  ],
