...
export const thalleLaPassTrek: Tour = {
  ...
  itinerary: [
    { day: 1, title: "Arrival in Islamabad", activities: ["Smooth airport transfer and hotel check-in", "Half-day tour of Pakistan's capital — friendly faces, colorful markets, and a taste of its dynamic energy"], accommodation: "Hotel", image: { src: "/images/photos/islamabad.jpeg", alt: "Islamabad city view", width: 1200, height: 800 } },
    { day: 2, title: "Islamabad to Skardu / Chilas", activities: ["Scenic flight to Skardu, or a road adventure along the Karakoram Highway to Chilas, 10–12 hours", "Altitude: 2,250m", "Settle into the hotel and unwind before the days ahead"], accommodation: "Hotel", image: { src: "/images/photos/chilas.jpg", alt: "Chilas city view", width: 1200, height: 800 } },
    { day: 3, title: "Explore Skardu", activities: ["Kharpocho Fort, the serene Manthal Buddha Rock, and Sadpara Lake", "Optional visits to Upper Kachura Lake or Broq, and time for last-minute shopping", "By road: continue from Chilas to Skardu, 7–8 hours, with stunning mountain views"], accommodation: "Hotel", image: { src: "/images/photos/Khaplu_Palace_Skardu,_Gilgit_Baltistan,_Pakistan.jpg", alt: "Khaplu Palace in Skardu, Gilgit Baltistan", width: 1200, height: 800 } },
    ...
    { day: 5, title: "Thalle Camp to Daserpa", activities: ["A longer, more adventurous day deeper into high-altitude terrain", "Wide alpine meadows, glacial streams, and rugged mountain landscapes, crossing Thalle La Pass at 4,572m", "Steady climbs and long descents — rewarding but demanding", "5–7 hours"], accommodation: "Camping", image: { src: "/images/photos/ThalayLaTrek.jpg", alt: "Trekking route near Thalle La Pass in Gilgit-Baltistan", width: 1200, height: 800 } },
    { day: 6, title: "Daserpa to Shigar", activities: ["Scenic descent through mountain trails, valleys, and villages, mostly downhill", "Trek concludes at Shigar", "Comfortable drive to Skardu"], accommodation: "Hotel", image: { src: "/images/photos/shigar.jpg", alt: "Shigar city view", width: 1200, height: 800 } },
    { day: 7, title: "Skardu to Islamabad", activities: ["Flight from Skardu with aerial views of the Karakoram, or a scenic drive to Chilas or Naran through lush valleys, rivers, and high mountain passes", "Settle into a comfortable hotel to rest and reflect on the trek"], accommodation: "Hotel", image: { src: "/images/photos/flight.jpeg", alt: "Flight to Islamabad", width: 1200, height: 800 } },
