...
export const nomadsWildFrontierOverland: Tour = {
  ...
  itinerary: [
    ...
    { day: 4, title: "Chitral → Kalash Valley", activities: ["Jeep track into Bumburet/Rumbur Valley", "Cultural immersion with the Kalash tribe"], accommodation: "Homestay", image: { src: "/images/photos/Pakistan_valley_kalash_people_festival.jpg", alt: "Kalash people celebrating a festival in the valley", width: 1200, height: 800 } },
    { day: 5, title: "Kalash Cultural Day", activities: ["Free exploration, short hikes & nature walks", "Learn local traditions and history"], accommodation: "Homestay", image: { src: "/images/photos/58dbaf127baf3.jpg", alt: "Cultural experience in northern Pakistan's mountain valleys", width: 1200, height: 800 } },
    { day: 6, title: "Kalash → Shandur Pass", activities: ["Epic 4x4 adventure day crossing Shandur Pass at 3,700m", "Continue to Phander Lake"], accommodation: "Camping", image: { src: "/images/photos/Shandur-Polo-Festivals_kahtours.jpg", alt: "Shandur Pass, the world's highest polo ground", width: 1200, height: 800 } },
    ...
    { day: 8, title: "Gilgit → Hunza Valley", activities: ["Drive on the Karakoram Highway", "Visit Baltit & Altit Forts", "Sunset over Rakaposhi & Ultar peaks"], accommodation: "Hotel", image: { src: "/images/photos/ultar-peak.jpg", alt: "Ultar Peak rising above Karimabad in the Hunza Valley", width: 1200, height: 800 } },
    { day: 9, title: "Upper Hunza Exploration", activities: ["Attabad Lake boating, Passu Cones photography", "Hussaini Suspension Bridge and Borith Lake sunset"], accommodation: "Guesthouse", image: { src: "/images/photos/Passu_Cones,_Karakoram_range,_Gilgit_Baltistan,_Pakistan.jpg", alt: "Passu Cones rising above the Karakoram valley", width: 1200, height: 800 } },
    { day: 10, title: "Hunza → Skardu", activities: ["Off-road jeep journey via the Indus River into Baltistan"], accommodation: "Hotel" },
    { day: 11, title: "Skardu Sightseeing", activities: ["Shangrila (Lower Kachura) Lake, Satpara Lake, Kharpocho Fort hike"], accommodation: "Hotel", image: { src: "/images/photos/Khaplu_Palace_Skardu,_Gilgit_Baltistan,_Pakistan.jpg", alt: "Khaplu Palace in Skardu, Gilgit Baltistan", width: 1200, height: 800 } },
    ...
    { day: 13, title: "Khaplu → Hushe Valley", activities: ["Journey along the Nomads' Mountain Passage into pristine valleys and towering alpine peaks"], accommodation: "Guesthouse", image: { src: "/images/photos/nangmah-valley.jpg", alt: "Dramatic mountain valley in Gilgit-Baltistan near Khaplu", width: 1200, height: 800 } },
