...
export const nomadicPoloExperience: Tour = {
  ...
  itinerary: [
    ...
    { day: 2, title: "Explore Gilgit → Hunza", activities: ["2–3 hours via the KKH", "Baltit Fort, Altit Fort, and Karimabad Bazaar"], accommodation: "Homestay / Guesthouse", image: { src: "/images/photos/ultar-peak.jpg", alt: "Ultar Peak rising above the Hunza Valley near Karimabad", width: 1200, height: 800 } },
    { day: 3, title: "Hunza Exploration & Gupis Travel", activities: ["Passu Cones, Hussaini Suspension Bridge, and Attabad Lake", "Afternoon travel to Gupis, ~6 hours"], accommodation: "Guesthouse", image: { src: "/images/photos/Passu_Cones,_Karakoram_range,_Gilgit_Baltistan,_Pakistan.jpg", alt: "Passu Cones rising dramatically above the Karakoram valley", width: 1200, height: 800 } },
    { day: 4, title: "Gupis → Shandur Base Camp", activities: ["5–6 hours on mountainous roads", "Nomadic-style camp arrival and gear preparation"], accommodation: "Camping", image: { src: "/images/photos/1_Group_PakistanChineseborder-KunjerabPass.jpg", alt: "Mountain road journey at high altitude toward Shandur Pass", width: 1200, height: 800 } },
    { day: 5, title: "Shandur Polo Festival Day 1", activities: ["Freestyle polo matches", "Local music, dances, and campfire gathering"], accommodation: "Camping", image: { src: "/images/photos/Shandur-Polo-Festivals_kahtours.jpg", alt: "Freestyle polo match at the legendary Shandur Polo Festival", width: 1200, height: 800 } },
    { day: 6, title: "Shandur Polo Festival Day 2", activities: ["Polo matches and local games", "Optional alpine meadow hikes"], accommodation: "Camping", image: { src: "/images/photos/Shandur-Polo-Festivals_kahtours.jpg", alt: "Shandur Polo Festival at the world's highest polo ground", width: 1200, height: 800 } },
    ...
    { day: 9, title: "Chitral → Kalash Valley", activities: ["2–3 hours to Bumburet/Rumbur", "Cultural exploration, music, and dances"], accommodation: "Homestay", image: { src: "/images/photos/Pakistan_valley_kalash_people_festival.jpg", alt: "Kalash people celebrating a festival in the valley", width: 1200, height: 800 } },
    { day: 10, title: "Kalash Cultural Immersion", activities: ["Local rituals and traditional crafts", "Learning about Kalash history & beliefs"], accommodation: "Homestay", image: { src: "/images/photos/58dbaf127baf3.jpg", alt: "Cultural experience in the Kalash Valley of northern Pakistan", width: 1200, height: 800 } },
